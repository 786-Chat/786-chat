...
test("undo targets the latest user edit, skips build repair snapshots and queues a rebuild", async () => {
...
test("manual restore queues a fresh build so live preview can move to the restored source", async () => {
