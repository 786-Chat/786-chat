...
type GenerationBatch = { name: string; files: string[] }
...
function createBatches(files: string[]): GenerationBatch[] {
  const buckets = [
    ...
    { name: "application-shell-and-primary-pages", files: [] as string[] },
    { name: "backend-apis-and-server-services", files: [] as string[] },
