...
export const SYSTEM_BLUEPRINTS: readonly SystemBlueprint[] = [
  blueprint({
    ...
    workflows: ["lead-to-opportunity", "opportunity-stage-change", "follow-up-task", "customer-history"],
  ...
  blueprint({
    ...
    workflows: ["supplier-receipt-to-batch", "plan-to-production-run", "quality-release-or-hold", "batch-to-dispatch", "recall-trace"],
  ...
  blueprint({
    ...
    workflows: ["device-registration-and-pairing", "telemetry-to-alert", "alert-acknowledgement", "technician-dispatch", "maintenance-history"],
  ...
  blueprint({
    ...
    roles: ["platform-owner", "company-owner", "administrator", "technician", "customer", "auditor"],
    workflows: ["device-provisioning", "gateway-pairing", "telemetry-ingestion", "alert-acknowledgement", "firmware-rollout"],
