        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            {selectedCustomer?.vip && (
              <span className="vip-badge ml-2 bg-gold text-white text-xs font-bold px-2 py-0.5 rounded-full">VIP Guest</span>
            )}
          </div>
              ...
              {reservations.map((r) => (
                <tr key={r.id} className="border-b">
                  <td className="py-2">
                    ...
                    {r.customer_vip && <span className="vip-badge ml-2 bg-gold text-white text-xs font-bold px-2 py-0.5 rounded-full">VIP</span>}
                  </td>
