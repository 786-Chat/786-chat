...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { product_id, movement_type, qty, reference, user_id, user_name, batch_number, batch_id, best_before_date, use_by_date, expiry_date, received_temperature } = body;
    ...
    if (movement_type === 'STOCK IN') {
      ...
      const batchResult = await query(
        `INSERT INTO stock_batches (batch_number, product_id, sku, product_name, qty_received, qty_remaining, unit, stock_in_date, stock_in_time, reference, supplier, best_before_date, use_by_date, expiry_date, status, created_by, received_temperature, storage_type, min_temperature, max_temperature) VALUES ($1, $2, $3, $4, $5, $5, $6, $7, $8, $9, $10, $11, $12, $13, 'ACTIVE', $14, $15, $16, $17, $18) RETURNING *`,
        [batchNumber, product_id, product.sku, product.product_name, qtyNum, product.unit, stockInDate, stockInTime, reference || '', product.supplier || '', best_before_date || null, use_by_date || null, expiry_date || null, user_name, received_temperature || null, product.storage_type, product.min_temperature, product.max_temperature]
      );
