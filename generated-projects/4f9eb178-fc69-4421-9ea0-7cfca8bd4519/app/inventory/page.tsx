...
import { Trash2, PackagePlus, Pencil, PackageMinus } from 'lucide-react';
            ...
            return (
              <article key={p.id} className="min-w-0 rounded-xl border border-gray-200 bg-white/85 p-4 shadow-sm">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  ...
                  <button type="button" onClick={() => openStockOut(p)} className="inline-flex items-center gap-1 rounded-lg border border-amber-500 bg-amber-50 px-3 py-2 text-sm font-medium text-amber-700"><PackageMinus className="h-4 w-4" />Stock Out</button>
              ...
              return (
                <article key={p.id} className="flex items-stretch gap-6 rounded-xl border border-gray-200 bg-white/85 p-6 shadow-sm">
                  ...
                  <div className="flex min-w-0 w-[22%] flex-col items-start justify-center gap-2">
                    ...
                    <button type="button" onClick={() => openStockOut(p)} className="inline-flex h-10 w-[110px] items-center justify-center gap-2 rounded-lg border border-amber-500 bg-amber-50 text-sm font-medium text-amber-700 transition hover:bg-amber-100 focus:outline-none focus:ring-2 focus:ring-amber-500">
