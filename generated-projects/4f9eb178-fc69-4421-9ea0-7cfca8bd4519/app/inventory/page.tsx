                ...
                <div className="mt-4 hidden overflow-x-auto sm:block">
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody>
                      ...
                      {movements.length === 0 && <tr><td colSpan={12} className="py-6 text-center text-gray-500">No movements found</td></tr>}
                    </tbody>
                  </table>
                </div>
                ...
                <div className="mt-4 space-y-3 sm:hidden">
                  {movements.map((m) => (
                    <article key={m.id} className="rounded-xl border border-gray-200 bg-white/85 p-4 shadow-sm">
                      ...
                      <p className="mt-2 text-sm text-gray-600">Reference: {m.reference || '—'}</p>
                      <p className="mt-1 text-sm text-gray-600">User: {m.user_name}</p>
                    </article>
                  ))}
                  {movements.length === 0 && <p className="py-6 text-center text-gray-500">No movements found</p>}
                </div>
