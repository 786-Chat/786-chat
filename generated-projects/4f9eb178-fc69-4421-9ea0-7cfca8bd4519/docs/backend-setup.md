...
- `PATCH /api/products/:id` - Update a product (supports stock details fields)
- `DELETE /api/products/:id` - Delete a product

### Stock Movements
- `GET /api/stock-movements` - List stock movements with filters and pagination
- `POST /api/stock-movements/transaction` - Record a stock in/out transaction (updates product stock and creates movement record atomically)
