      ...
      >
        ...
        <div
          className={cn(
            ...
            "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[collapsible=icon]:group-data-[side=left]:left-0 group-data-[collapsible=icon]:group-data-[side=right]:right-0",
            className
          )}
          {...props}
        >
