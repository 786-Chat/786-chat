    ...
    <Card className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border-purple-500/30 w-full max-w-full overflow-hidden">
      <CardHeader className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 w-full max-w-full">
        ...
        <div className="flex justify-center lg:justify-end lg:ml-6">
          ...
          <DialogContent className="bg-black/95 border-purple-500/30 top-2 bottom-2 translate-y-0 max-h-none h-auto overflow-y-auto overscroll-contain w-[calc(100%-1rem)] sm:max-w-xl p-4 sm:p-6">
            <DialogHeader>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="sticky bottom-0 z-20 flex justify-end space-x-2 pt-3 pb-1 bg-black/95 border-t border-purple-500/30">
                  <Button 
                    type="button" 
                    variant="outline" 
                    onClick={() => {
                  ...
                  >
                    {createMutation.isPending ? "Sending..." : `Create & Send${selectedBranches.length ? ` (${selectedBranches.length})` : ""}`}
                  </Button>
                </div>
              </form>
            </Form>
