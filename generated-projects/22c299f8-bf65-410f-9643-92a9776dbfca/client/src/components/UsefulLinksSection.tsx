...
export default function UsefulLinksSection() {
  ...
  const branches = (branchesResponse?.branches || []).filter((branch) => Boolean(branch?.name?.trim()));
    ...
    <Card className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border-purple-500/30 w-full max-w-full overflow-hidden">
      <CardHeader className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0 w-full max-w-full">
        ...
        <div className="flex justify-center lg:justify-end lg:ml-6">
          ...
          <DialogContent className="bg-black/95 border-purple-500/40 w-[calc(100%-1.5rem)] sm:max-w-lg max-h-[90vh] overflow-y-auto overscroll-contain p-5 sm:p-6 rounded-2xl shadow-2xl shadow-purple-950/50">
            <DialogHeader>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="bg-slate-900/80 border-purple-500/40 text-white rounded-lg focus-visible:ring-purple-500/40"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <div className="space-y-4">
                  ...
                  {/* Branch List */}
                  <div className="h-48 overflow-y-auto border border-purple-500/30 rounded-lg bg-black/40 p-3 space-y-2">
                ...
                <div className="flex justify-end gap-2 pt-3 mt-2 border-t border-purple-500/20">
                  <Button 
                    type="button" 
                    variant="outline" 
                    onClick={() => {
