  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center max-w-7xl mx-auto w-full min-w-0 gap-4 py-6">
        ...
        {/* Compact mouse-catch marketing video */}
        <div className="w-full max-w-sm px-2">
          <div className="rounded-xl overflow-hidden border border-purple-400/30 bg-slate-950/90 shadow-xl">
            <div className="px-3 py-2 border-b border-white/10 bg-gradient-to-r from-purple-900/70 to-pink-900/40">
              <div className="text-xs font-semibold text-white">Smart Mouse Protection</div>
              <div className="text-[10px] text-purple-300 mt-0.5">See how the trap works</div>
            </div>
            <video
              src={branchVideos[0]}
              controls
