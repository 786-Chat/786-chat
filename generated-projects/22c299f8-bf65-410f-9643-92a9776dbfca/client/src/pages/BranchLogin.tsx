  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        @media (min-width: 640px) { .branch-login-cube-stage { --cube-size: 148px; margin-bottom: 32px; } }
        @media (min-width: 1024px) { .branch-login-cube-stage { --cube-size: 160px; margin-bottom: 34px; } }
        @media (prefers-reduced-motion: reduce) { .branch-login-cube { animation: none; transform: rotateX(-14deg) rotateY(-32deg); } }
      `}</style>

      <div className="branch-login-approved-brand absolute top-4 left-4 sm:top-6 sm:left-6 z-30 max-w-[calc(100%-5rem)] text-left pointer-events-none">
      ...
      <footer className="branch-login-approved-footer relative z-20 w-full text-center text-xs sm:text-sm text-slate-300 pb-3 pt-1 px-4">
