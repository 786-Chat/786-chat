    ...
    >
      ...
      <style>{`
        ...
        .branch-login-cube-face {
          ...
          border-radius: 10px;
          background: linear-gradient(145deg, rgba(5,46,22,.98), rgba(22,101,52,.94));
          box-shadow: inset 0 0 22px rgba(255,255,255,.1), 0 0 22px rgba(34,197,94,.45);
        ...
        @media (min-width: 640px) { .branch-login-cube-stage { --cube-size: 148px; margin-bottom: 20px; } }
        @media (min-width: 1024px) { .branch-login-cube-stage { --cube-size: 160px; margin-bottom: 22px; } }
        @media (prefers-reduced-motion: reduce) { .branch-login-cube { animation: none; transform: rotateX(-14deg) rotateY(-32deg); } }
      `}</style>

      <div className="branch-login-approved-brand absolute top-4 left-4 sm:top-5 sm:left-5 z-30 max-w-[calc(100%-5rem)] text-left pointer-events-none">
      ...
      <div className="relative z-20 flex flex-col items-center justify-start max-w-md mx-auto w-full min-w-0 gap-3 pt-20 sm:pt-16 pb-6 px-3">
        ...
        <Card className="w-full max-w-md bg-slate-800/50 backdrop-blur-xl border-purple-500/30 shadow-2xl mx-auto w-full">
      ...
      {showSupportPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Popup Card */}
          <Card className="relative z-50 w-full max-w-md bg-slate-800/95 backdrop-blur-xl border-blue-500/30 shadow-2xl animate-in fade-in zoom-in duration-300 mx-auto w-full">
      ...
      <footer className="branch-login-approved-footer relative z-20 w-full max-w-md mx-auto text-center text-[10px] sm:text-xs text-slate-300 pb-3 pt-2 px-4">
