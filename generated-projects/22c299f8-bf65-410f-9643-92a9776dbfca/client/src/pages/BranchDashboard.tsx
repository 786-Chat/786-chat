...
const branchDashboardVideo = "https://cdn.jsdelivr.net/gh/786-Chat/786-chat@43efbbe87f3aca121164fd775f5cfb1389faf74d/generated-projects/22c299f8-bf65-410f-9643-92a9776dbfca/client/public/branch-video-2.mp4";
...
export default function BranchDashboard() {
  ...
  const handleLogout = async () => {
    try {
      await fetch("/api/branch/logout", { method: "POST", credentials: "include" });
    } catch (_) {}
      ...
      case "dashboard":
        return (
          <div className="space-y-6">
            ...
            {/* Compact branch marketing video */}
            <div className="mb-6 flex justify-center">
              <div className="w-full max-w-sm rounded-xl overflow-hidden border border-purple-400/30 bg-slate-950/90 shadow-xl">
                <div className="px-3 py-2 border-b border-white/10 bg-gradient-to-r from-blue-900/70 to-purple-900/50">
                  <div className="text-xs font-semibold text-white">Smart Pest Monitoring</div>
                  <div className="text-[10px] text-slate-300 mt-0.5">Device demonstration</div>
                </div>
                <video
                  src={branchDashboardVideo}
                  controls
                  muted
                  playsInline
                  preload="metadata"
