...
const steps = [
  ...
  },
  {
    ...
    description: "When raw ingredients arrive, staff complete the Delivery / Goods Received form and the received quantity is added to Stock.",
    icon: Truck,
  ...
  },
  {
    ...
    description: "Production uses the required ingredients and quantities from Stock for the Kulfi manufacturing batch.",
    icon: ClipboardList,
  ...
  {
    number: 9,
    title: "Production Complete → Ready Stock",
    description: "When the production batch is completed, the finished Kulfi quantity is added to Ready Stock.",
    icon: Factory,
  ...
  },
  {
    ...
    description: "Store the finished Kulfi under the approved freezer controls.",
    icon: Boxes,
    cardClass: "border-blue-200 bg-blue-50",
    iconClass: "bg-blue-500 text-white",
    titleClass: "text-blue-900",
  ...
  },
  {
    number: 11,
    title: "Distribution",
    description: "Dispatch finished Kulfi using suitable refrigerated transport to maintain the cold chain.",
    icon: Truck,
    cardClass: "border-green-200 bg-green-50",
    iconClass: "bg-green-500 text-white",
    titleClass: "text-green-800",
