    ...
    <div className="space-y-5">
      <div className="overflow-hidden rounded-2xl border border-slate-700 bg-slate-950 shadow-xl">
        ...
        <div className="overflow-x-auto scrollbar-thin">
          <table className="min-w-[860px] w-full border-collapse text-xs sm:min-w-[980px] sm:text-sm">
            <thead>
              <tr className="bg-slate-800 text-white">
                <th className="min-w-[250px] px-3 py-4 text-left sm:min-w-[360px] sm:px-4">Tasks</th>
