...
export default async function OrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <header className="bg-slate-900 text-white p-4 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="inline-flex items-center gap-1.5 rounded-md border border-slate-700 px-3 py-2 text-sm font-medium text-slate-200 hover:bg-slate-800 hover:text-white">
            <ArrowLeft size={16} /> Back to Dashboard
          </Link>
          <h1 className="text-xl font-bold">Orders</h1>
        </div>
        <Link href="/orders/new" className="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded flex items-center justify-center gap-2">
