...
import { CheckCircle2, Snowflake, Thermometer, PackageCheck, ArrowRight, Flame, Gauge, Clock } from "lucide-react";
...
export function ProductionView() {
  ...
  const steps = [
    { label: "Start Temperature", icon: Gauge, tone: "blue" },
    { label: "Heating", icon: Flame, tone: "blue" },
    ...
    { label: "Freezer storage temperature recorded", icon: PackageCheck, tone: "freezer" }
  ];
