...
function getStorageTemperatureError(instruction: string, value: string): string | null {
  ...
  if (instruction === "Keep Frozen") {
    ...
    if (num > 8) return "Storage Temperature must be 8°C or below for refrigerated storage.";
...
export function ProductionView() {
  const [formData, setFormData] = useState<Record<string, string>>(() => {
    ...
    return { date: today, storageInDate: today };
  });
        ...
        <CardContent className="p-4 sm:p-6">
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col">
                <label className="mb-1 text-sm font-semibold">Storage Temperature</label>
