...
import { CheckCircle2, Snowflake, Thermometer, PackageCheck, ArrowRight } from "lucide-react";
...
export function ProductionView() {
  ...
  const steps = [
    { label: "Cooling complete", icon: CheckCircle2, tone: coolingComplete ? "complete" : "pending" },
    { label: "Below 9°C", icon: Thermometer, tone: coolingComplete ? "complete" : "pending" },
    { label: "Moved to freezer", icon: Snowflake, tone: coolingComplete ? "complete" : "pending" },
    { label: "Freezer storage temperature recorded", icon: PackageCheck, tone: coolingComplete ? "complete" : "pending" }
  ];
                  ...
                  >
                    <step.icon
                      className={`h-6 w-6 shrink-0 ${
                        step.tone === "complete" ? "text-emerald-500" : "text-slate-400"
                      }`}
                    />
                    <span
                      className={`text-sm font-semibold ${
                        step.tone === "complete" ? "text-emerald-800" : "text-slate-600"
                      }`}
                    >
                      {step.label}
                    </span>
