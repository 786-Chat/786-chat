    ...
    <div className="min-h-screen bg-[#070B19] text-slate-200">
      ...
      {pageKey === 'home' && (
        <>
          ...
          <section id="signature" className="py-20 bg-[#0B132B]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-4xl font-serif text-center mb-12 text-white">Our <span className="text-gradient-gold">Signature Coffees</span></h2>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="btn-gold px-4 py-2 rounded-full text-sm font-semibold">Order Now</button>
                      </div>
                    </div>
                  </div>
                ))}
