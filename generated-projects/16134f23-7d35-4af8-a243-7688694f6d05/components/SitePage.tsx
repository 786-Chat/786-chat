...
type PageKey = 'home' | 'about' | 'contact' | 'menu';
    ...
    <div className="min-h-screen bg-[#070B19] text-slate-200">
      ...
      <section id="home" className="bg-hero min-h-screen flex items-center justify-center text-center px-4 pt-16">
        <div className="max-w-3xl animate-fadeUp">
          ...
          <p className="text-slate-300 text-lg mb-8 max-w-xl mx-auto">Experience the perfect blend of rich flavors and cozy atmosphere.</p>
