      ...
      <header className="fixed top-0 w-full z-50 bg-[#070B19]/90 backdrop-blur-md border-b border-gold/10 shadow-lg">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8 text-slate-300">
            <a href="/" className="hover:text-gold transition font-medium">Home</a>
            <a href="/menu" className="hover:text-gold transition font-medium">Menu</a>
            <a href="/gallery" className="hover:text-gold transition font-medium">Gallery</a>
            <a href="/about" className="hover:text-gold transition font-medium">About</a>
            <a href="/contact" className="hover:text-gold transition font-medium">Contact</a>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#070B19]/95 border-b border-gold/10 px-4 pb-4 space-y-2">
            <a href="/" onClick={() => setMenuOpen(false)} className="block text-slate-200 hover:text-gold py-2">Home</a>
            <a href="/menu" onClick={() => setMenuOpen(false)} className="block text-slate-200 hover:text-gold py-2">Menu</a>
            <a href="/gallery" onClick={() => setMenuOpen(false)} className="block text-slate-200 hover:text-gold py-2">Gallery</a>
            <a href="/about" onClick={() => setMenuOpen(false)} className="block text-slate-200 hover:text-gold py-2">About</a>
            <a href="/contact" onClick={() => setMenuOpen(false)} className="block text-slate-200 hover:text-gold py-2">Contact</a>
          </div>
        )}
      </header>
