...
export function PwaSplashScreen({ appName, accentColor, iconComponent, onComplete }: PwaSplashScreenProps) {
  ...
  return (
    ...
    >
      ...
      >
        <source src="https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788723058964-ecc9725b-95ec-44a8-bdb2-c5803e1f8841-splash-video-ycoiSWPikANdPwLsTzHdrXy4DaxzIs.mp4" type="video/mp4" />
      </video>
