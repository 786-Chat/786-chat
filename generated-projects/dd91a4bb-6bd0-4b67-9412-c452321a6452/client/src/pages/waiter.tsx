...
export default function WaiterPage() {
  ...
  useEffect(() => {
    ...
    if (appleTouchIcon) {
      appleTouchIcon.setAttribute('href', 'https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722796212-7ee26760-dc21-49fe-96d0-8d960cb01532-icon-waiter-512-jbEeiERDSFJLjC5sGVYtIgG7VrzShz.png');
    }
    if (metaThemeColor) {
