...
export default function PropertyWebsite() {
  ...
  useEffect(() => {
    ...
    if (appleTouchIcon && branch) {
      const iconUrl = branch.appIconUrl || branch.logoUrl || 'https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722779267-668e5773-ff08-404b-85ff-2196909aa780-icon-192-i7rYC2Ylt5e8dEXC0WsHhG5lmttOMr.png';
