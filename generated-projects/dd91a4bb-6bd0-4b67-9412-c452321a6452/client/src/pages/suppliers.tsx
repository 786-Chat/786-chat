...
export default function SuppliersPage() {
  ...
  useEffect(() => {
    ...
    if (appleTouchIcon) {
      appleTouchIcon.setAttribute('href', 'https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722793858-5269d09b-bdc9-4439-be9a-2601dbab64b5-icon-suppliers-512-JpFroZ2a0WyyiWEh03SOfCC3WJ8aE9.png');
    }
    if (metaThemeColor) {
