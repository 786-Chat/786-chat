      ...
      {(backgroundType === "video" || heroVideo) && heroVideo ? (
        ...
        <>
          ...
          <div 
            ...
            style={{
              backgroundImage: `url('https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722771755-49840016-2c3a-482d-a996-330f505ef9fb-dasi-rainbow-bg-YICieXzbos2CjuGVER1lA93k3UlOnZ.gif')`,
