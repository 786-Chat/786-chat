...
export default function FinancesPage() {
  ...
  useEffect(() => {
    ...
    if (appleTouchIcon) {
      appleTouchIcon.setAttribute('href', 'https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722787968-6da9f811-4d19-4f3e-b363-962df2733b71-icon-finances-512-ouKOeed6kx6sPuOrRpRKZ7wdHTr2pb.png');
    }
    if (metaThemeColor) {
