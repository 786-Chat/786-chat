  ...
  return (
    <Modal title={brand ? "Edit Brand" : "Add Brand Company"} onClose={onClose}>
      <div className="space-y-3">
        ...
        <div><label className="text-sm font-medium text-white/60">Logo URL</label><input value={form.logoUrl} onChange={e => setForm({ ...form, logoUrl: e.target.value })} placeholder="https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722767716-670cfb23-26d3-454c-94c3-8b1c44ed2362-chillpack-logo-MfD2dLK0JEuhZmAEj5hI2GrtSSwS0C.png" className={inputClass} /></div>
        <div className="grid grid-cols-2 gap-3">
