...
import groceryRoutes, { setupGroceryWebSocket, seedGroceryDataIfEmpty } from "./grocery-routes.js";
import marketingRoutes from "./marketing-routes.js";
import taxiRoutes, { setupTaxiWebSocket } from "./taxi-routes.js";
import clothingRoutes from "./clothing-routes.js";
...
import { seedEcommerceData } from "./seed-ecommerce.js";
import { syncTawaWatfordOnStartup } from "./sync-tawa-watford.js";
import { syncHelloMumbaiOnStartup } from "./sync-hello-mumbai.js";
import { storage } from "./storage.js";
import { registerImageRoutes } from "./replit_integrations/image/index.js";
import { registerDisplayMenuRoutes } from "./display-menu-routes.js";
import { registerTvDisplayRoutes, ensureTvDisplayTable } from "./tv-display-routes.js";
...
(async () => {
  ...
  if (!process.env.VERCEL) httpServer.listen({ port, host: "0.0.0.0", reusePort: true }, () => {
  ...
  const { setupClothingWebSocket } = await import("./clothing-routes.js");
  setupClothingWebSocket(httpServer);

  // Setup furniture WebSocket on /furniture-ws path
  const { setupFurnitureWebSocket } = await import("./furniture-routes.js");
