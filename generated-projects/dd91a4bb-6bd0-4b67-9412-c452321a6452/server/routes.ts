...
import { tawaRestaurantData, tawaMenuItems } from "./data/tawaMenu.js";
import { dhabaRestaurantData, dhabaMenuItems } from "./data/dhabaMenu.js";
import { tawaWatfordRestaurantData, tawaWatfordCategories, tawaWatfordMenuItems } from "./data/tawaWatfordMenu.js";
...
import { autoSeedBranches } from "./auto-seed.js";
...
${urls}
  ...
  app.post("/api/reset-branch-menu/:slug", async (req, res) => {
    try {
      ...
      const { embeddedSeedData } = await import("./embedded-seed-data.js");
  ...
  app.get("/api/restaurants/:slug/manifest.json", async (req, res) => {
    try {
      ...
      const icons = iconSrc ? [
        ...
        {
          src: "https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722791143-6b1812d0-74a7-4d55-8037-c8c504ca6c96-icon-menu-192-WM5zvgbR54WGvwdBGv3xrS4rDNcQZQ.png",
          sizes: "192x192",
          type: "image/png",
          purpose: "any maskable"
        },
        {
          src: "https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722791959-5ffd876e-a9e0-47c7-8426-eb48390d6e95-icon-menu-512-Bu70bRWZLMpRC37V8TvWPrQjkKwaYE.png",
          sizes: "512x512",
          type: "image/png",
          purpose: "any maskable"
        }
...
${restaurant?.phone || ''}
  ...
  app.get("/api/manifest/:slug", async (req, res) => {
    try {
      ...
      const logoIcon = restaurant.logoUrl || "https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722791959-5ffd876e-a9e0-47c7-8426-eb48390d6e95-icon-menu-512-Bu70bRWZLMpRC37V8TvWPrQjkKwaYE.png";
  ...
  app.get("/api/property-branches/:slug/manifest.json", async (req, res) => {
    try {
      ...
      const manifest = {
        ...
        icons: [
          {
            src: branch.appIconUrl || branch.logoUrl || "https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722779267-668e5773-ff08-404b-85ff-2196909aa780-icon-192-i7rYC2Ylt5e8dEXC0WsHhG5lmttOMr.png",
            sizes: "192x192",
            type: "image/png",
            purpose: "any maskable"
          },
          {
            src: branch.appIconUrl || branch.logoUrl || "https://0qshtsle6wr4hqxp.public.blob.vercel-storage.com/imports/1788722780041-28a2179e-ffab-45fd-8673-33e89a20b5e8-icon-512-g439u836H4u1NiJX0IT9F2tx1loIpc.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "any maskable"
          }
  ...
  async function autoPushExtensionToUcm(ext: any): Promise<{ ok: boolean; error?: string }> {
    try {
      ...
      const { withUcmClient } = await import("./lib/ucm-client.js");
