-- Imported from migrations/0000_elite_wind_dancer.sql
CREATE TYPE "public"."booking_status" AS ENUM('pending', 'confirmed', 'cancelled');
CREATE TYPE "public"."delivery_status" AS ENUM('unassigned', 'assigned', 'accepted', 'picked_up', 'delivering', 'completed', 'rejected', 'returned');
CREATE TYPE "public"."driver_license_type" AS ENUM('uk_full', 'international');
CREATE TYPE "public"."driver_payment_type" AS ENUM('mileage', 'salary', 'salary_plus_commission');
CREATE TYPE "public"."driver_salary_period" AS ENUM('weekly', 'monthly');
CREATE TYPE "public"."epos_discount_type" AS ENUM('fixed', 'percent');
CREATE TYPE "public"."expense_category" AS ENUM('supplier_invoice', 'staff_wages', 'rent', 'electric', 'gas', 'water', 'business_rates', 'rubbish', 'vehicle_insurance', 'business_insurance', 'mot', 'wastage', 'extra_expense', 'vat', 'tax', 'other');
CREATE TYPE "public"."hero_animation_style" AS ENUM('slide', 'fade', 'scrapbook', 'stomp', 'flicker', 'pulse', 'tectonic');
CREATE TYPE "public"."income_source" AS ENUM('customer_order', 'epos_sale', 'waiter_order', 'cash_deposit', 'other_income');
CREATE TYPE "public"."order_item_status" AS ENUM('pending', 'preparing', 'ready');
CREATE TYPE "public"."order_status" AS ENUM('pending_approval', 'new', 'preparing', 'ready', 'completed');
CREATE TYPE "public"."order_type" AS ENUM('delivery', 'takeaway', 'dine-in', 'collection');
CREATE TYPE "public"."payment_instruction" AS ENUM('customer_paid_online', 'collect_cash', 'branch_pays_driver');
CREATE TYPE "public"."payment_method" AS ENUM('cash', 'card', 'account', 'bank_transfer');
CREATE TYPE "public"."payment_method_type" AS ENUM('cash', 'bank_transfer', 'cheque');
CREATE TYPE "public"."recurring_frequency" AS ENUM('weekly', 'monthly', 'quarterly', 'yearly');
CREATE TYPE "public"."restaurant_status" AS ENUM('open', 'closed');
CREATE TYPE "public"."staff_pay_type" AS ENUM('hourly', 'weekly', 'monthly');
CREATE TYPE "public"."supplier_order_status" AS ENUM('draft', 'sent', 'received', 'cancelled');
CREATE TYPE "public"."supplier_unit_type" AS ENUM('kg', 'packet', 'piece', 'box', 'bottle', 'bag', 'case', 'other');
CREATE TYPE "public"."table_session_status" AS ENUM('ordering', 'awaiting_manager', 'approved', 'in_kitchen', 'ready', 'served', 'closed');
CREATE TYPE "public"."transaction_type" AS ENUM('income', 'expense');
CREATE TYPE "public"."waiter_status" AS ENUM('active', 'on_break', 'offline');
CREATE TYPE "public"."welcome_background_type" AS ENUM('image', 'gif', 'video', 'slider', 'gradient');
...
ALTER TABLE "branch_driver_assignments" ADD CONSTRAINT "branch_driver_assignments_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "branch_driver_assignments" ADD CONSTRAINT "branch_driver_assignments_driver_id_drivers_id_fk" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "branch_features" ADD CONSTRAINT "branch_features_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "branch_snapshots" ADD CONSTRAINT "branch_snapshots_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "call_recordings" ADD CONSTRAINT "call_recordings_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "cash_deposits" ADD CONSTRAINT "cash_deposits_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "customer_push_subscriptions" ADD CONSTRAINT "customer_push_subscriptions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "driver_location_updates" ADD CONSTRAINT "driver_location_updates_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "driver_location_updates" ADD CONSTRAINT "driver_location_updates_driver_id_drivers_id_fk" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "driver_payments" ADD CONSTRAINT "driver_payments_driver_id_drivers_id_fk" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "driver_payments" ADD CONSTRAINT "driver_payments_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "drivers" ADD CONSTRAINT "drivers_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "epos_orders" ADD CONSTRAINT "epos_orders_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "extra_toppings" ADD CONSTRAINT "extra_toppings_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "extra_toppings" ADD CONSTRAINT "extra_toppings_menu_item_id_menu_items_id_fk" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "financial_transactions" ADD CONSTRAINT "financial_transactions_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "gallery_images" ADD CONSTRAINT "gallery_images_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "kitchen_stations" ADD CONSTRAINT "kitchen_stations_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "menu_item_recommendations" ADD CONSTRAINT "menu_item_recommendations_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "menu_item_recommendations" ADD CONSTRAINT "menu_item_recommendations_source_item_id_menu_items_id_fk" FOREIGN KEY ("source_item_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "menu_item_recommendations" ADD CONSTRAINT "menu_item_recommendations_recommended_item_id_menu_items_id_fk" FOREIGN KEY ("recommended_item_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "menu_modifiers" ADD CONSTRAINT "menu_modifiers_menu_item_id_menu_items_id_fk" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "order_deliveries" ADD CONSTRAINT "order_deliveries_driver_id_drivers_id_fk" FOREIGN KEY ("driver_id") REFERENCES "public"."drivers"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "order_item_completions" ADD CONSTRAINT "order_item_completions_order_item_id_order_items_id_fk" FOREIGN KEY ("order_item_id") REFERENCES "public"."order_items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "order_item_completions" ADD CONSTRAINT "order_item_completions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "order_item_completions" ADD CONSTRAINT "order_item_completions_station_id_kitchen_stations_id_fk" FOREIGN KEY ("station_id") REFERENCES "public"."kitchen_stations"("id") ON DELETE set null ON UPDATE no action;
...
ALTER TABLE "popular_items" ADD CONSTRAINT "popular_items_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "properties" ADD CONSTRAINT "properties_branch_id_property_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."property_branches"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "property_appointments" ADD CONSTRAINT "property_appointments_branch_id_property_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."property_branches"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "property_appointments" ADD CONSTRAINT "property_appointments_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "property_video_links" ADD CONSTRAINT "property_video_links_branch_id_property_branches_id_fk" FOREIGN KEY ("branch_id") REFERENCES "public"."property_branches"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "recurring_expenses" ADD CONSTRAINT "recurring_expenses_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "restaurant_dashboard_settings" ADD CONSTRAINT "restaurant_dashboard_settings_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "restaurant_hero_images" ADD CONSTRAINT "restaurant_hero_images_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "staff_members" ADD CONSTRAINT "staff_members_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "staff_wage_payments" ADD CONSTRAINT "staff_wage_payments_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "staff_wage_payments" ADD CONSTRAINT "staff_wage_payments_staff_id_staff_members_id_fk" FOREIGN KEY ("staff_id") REFERENCES "public"."staff_members"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "supplier_order_items" ADD CONSTRAINT "supplier_order_items_product_id_supplier_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."supplier_products"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "supplier_orders" ADD CONSTRAINT "supplier_orders_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "supplier_orders" ADD CONSTRAINT "supplier_orders_supplier_id_suppliers_id_fk" FOREIGN KEY ("supplier_id") REFERENCES "public"."suppliers"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "table_session_items" ADD CONSTRAINT "table_session_items_session_id_table_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."table_sessions"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "table_session_items" ADD CONSTRAINT "table_session_items_menu_item_id_menu_items_id_fk" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "table_sessions" ADD CONSTRAINT "table_sessions_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "table_sessions" ADD CONSTRAINT "table_sessions_waiter_id_waiters_id_fk" FOREIGN KEY ("waiter_id") REFERENCES "public"."waiters"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "table_sessions" ADD CONSTRAINT "table_sessions_tablet_id_waiter_tablets_id_fk" FOREIGN KEY ("tablet_id") REFERENCES "public"."waiter_tablets"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "table_sessions" ADD CONSTRAINT "table_sessions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "topping_group_options" ADD CONSTRAINT "topping_group_options_group_id_topping_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."topping_groups"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "topping_groups" ADD CONSTRAINT "topping_groups_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "topping_groups" ADD CONSTRAINT "topping_groups_menu_item_id_menu_items_id_fk" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "twilio_settings" ADD CONSTRAINT "twilio_settings_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "waiter_tablets" ADD CONSTRAINT "waiter_tablets_restaurant_id_restaurants_id_fk" FOREIGN KEY ("restaurant_id") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "waiter_tablets" ADD CONSTRAINT "waiter_tablets_assigned_waiter_id_waiters_id_fk" FOREIGN KEY ("assigned_waiter_id") REFERENCES "public"."waiters"("id") ON DELETE set null ON UPDATE no action;
